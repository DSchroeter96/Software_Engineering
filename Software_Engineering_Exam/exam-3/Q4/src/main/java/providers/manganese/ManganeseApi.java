...
public interface ManganeseApi {
    ...
    /**
     * Representation of a manga, specific to Manganese. Each manga contains multiple books called chapters.
     *
    ...
    /**
     * Fetch synchronously a single page from a given chapter.
     ...
     * @param pageNumber Page number to fetch later
